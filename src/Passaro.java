public class Passaro {
	...
	public Passaro(double x, double y){
		...
		this.y = y;
		this.vy = 0;
		this.box = new Hitbox(x, y, x+8, y+6);
	...
	public void drawItself(Tela t){
		t.imagem("flappy.png", sprites_x[sprite_states[sprite_state]], sprites_y[sprite_states[sprite_state]], 44, 34, Math.atan(vy/200), x, y);
	}
